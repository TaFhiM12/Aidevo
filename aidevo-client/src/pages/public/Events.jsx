...
const Events = () => {
  ...
  const EventCard = ({ event }) => (
    <motion.div
      ...
      whileHover={{ y: -5 }}
      className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden group cursor-pointer transition-all duration-300 hover:shadow-xl"
    >
      {/* Event Image */}
      ...
      <div className="p-6">
        <div className="mb-3">
          <h3 className="font-bold text-gray-900 text-xl leading-tight line-clamp-2 mb-2 group-hover:text-[#4bbeff] transition-colors">
            {event.title}
          </h3>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <Link
            to={`/events/${event._id}`}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#4bbeff] to-blue-500 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-200 group"
          >
            View Details

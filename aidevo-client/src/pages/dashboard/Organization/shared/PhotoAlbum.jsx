...
import { Upload, X, ImageIcon, Loader2, ZoomIn, Download } from 'lucide-react';
        ...
        try {
            ...
            if (uploadedUrls.length > 0) {
                ...
                const response = await axios.patch(
                    `http://localhost:3000/organizations/${organizationId}/field`,
                    {
                ...
                if (response.data.success) {
                    ...
                    toast.success(`Uploaded ${uploadedUrls.length} photos successfully!`, { id: uploadToast });
                }
            }
        } catch (error) {
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-200">
                ...
                <p className="text-sm text-gray-500">
                    Upload multiple photos to showcase your organization's activities and events
                </p>
            </div>
            ...
            {photos.length > 0 ? (
                ...
                <div className="text-center py-12 bg-white rounded-2xl border-2 border-dashed border-gray-300">
                    ...
                    <p className="text-gray-500 mb-4">Upload photos to showcase your organization's activities</p>
                    <button
                        onClick={() => fileInputRef.current?.click()}

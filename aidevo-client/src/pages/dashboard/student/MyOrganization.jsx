  ...
  const OrganizationCard = ({ org }) => {
    ...
    return (
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden group transition-all duration-300 hover:shadow-xl"
      >
        ...
        <div className="p-6">
          <h3 className="font-bold text-gray-900 text-xl leading-tight mb-2 group-hover:text-blue-500 transition-colors">
            {orgName}
          </h3>
          ...
          <div className="pt-4 border-t border-gray-100">
            {orgId ? (
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-200"
              >
                View Organization
                <ExternalLink className="w-4 h-4" />
              </Link>
            ) : (
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-gray-200 text-gray-500 rounded-lg font-semibold text-sm">
